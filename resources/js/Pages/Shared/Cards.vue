    ...
    <div>
        ...
        <div v-for="post in posts.data" :key="post.id" class="
                        ...
                        <div class="ml-3">
                            <p class="
                                ...
                                <span class="
                                    ...
                                    duration-150
                                ">
                                    <InertiaLink :href="route('user-profile', { id: post.username })">@{{ post.username }}</InertiaLink> .  <InertiaLink :href="route('show-post', { id: post.id })">{{ post.time }}</InertiaLink>
                                </span>
                            </p>
                        </div>
                    </div>
            ...
            <div class="pl-16">
                ...
                <div v-if="post.downloadready !== null" class="flex mb-4 mr-2 w-full h-full">
                ...
                <div v-if="post.hasimage !== null" class="flex mb-4 pr-4 rounded-2xl w-full">
