                    ...
                    <div class="py-4">
                        ...
                        <div class="form-control py-2">
                            <label
                                ...
                                <input type="file" @input="form.files = $event.target.files[0]" name="files" id="files"
                                    class="opacity-0" />
                            </label>
                            <div v-if="form.errors.files" v-text="form.errors.files" class="text-red-500 mt-1"></div>
                        </div>

                        <div class="form-control py-2">
                            <input name="title" v-model="form.title" id="title" type="text" placeholder="Enter a title"
                                class="input input-bordered input-primary w-full" />
                            <div v-if="form.errors.title" v-text="form.errors.title" class="text-red-500 mt-1"></div>
                        </div>
                        <div class="form-control py-2">
                            <textarea v-model="form.description" id="description" name="description"
                                class="textarea textarea-primary" placeholder="Write a description"></textarea>
