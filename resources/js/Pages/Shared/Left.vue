            ...
            <div class="flex flex-col h-screen xl:pr-3 fixed overflow-y-auto w-68 xs:w-88 xl:w-275">
                ...
                <a class="flex my-3 justify-center xl:justify-start" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                        class="w-8 h-8 text-red-400 dark:text-white" viewBox="0 0 24 24" fill="none"
                ...
                <div v-if="$page.props.user !== null"
                    class="w-14 xl:w-full mx-auto mt-auto flex flex-row justify-between mb-10 rounded-full hover:bg-red-50 dark:hover:bg-dim-800 p-2 cursor-pointer transition duration-350 ease-in-out">
